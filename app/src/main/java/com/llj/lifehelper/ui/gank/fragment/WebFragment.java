 ...
 * </pre>
 */
public class WebFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("前端", 10, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("前端", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("前端", PAGE_SIZE, page);
		}
	}
}
