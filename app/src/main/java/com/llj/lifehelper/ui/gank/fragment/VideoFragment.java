 ...
 * </pre>
 */
public class VideoFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("休息视频", PAGE_SIZE, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("休息视频", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("休息视频", PAGE_SIZE, page);
		}
	}
}
