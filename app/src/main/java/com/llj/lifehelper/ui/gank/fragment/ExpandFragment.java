 ...
 * </pre>
 */
public class ExpandFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("拓展资源", PAGE_SIZE, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("拓展资源", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("拓展资源", PAGE_SIZE, page);
		}
	}
}
