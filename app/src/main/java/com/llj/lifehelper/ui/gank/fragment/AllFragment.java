 ...
 * </pre>
 */
public class AllFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("all", PAGE_SIZE, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("all", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("all", PAGE_SIZE, page);
		}
	}
}
