 ...
 * </pre>
 */
public class IOSFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("iOS", PAGE_SIZE, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("iOS", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("iOS", PAGE_SIZE, page);
		}
	}
}
