 ...
 * </pre>
 */
public class AppFragment extends BaseFragment implements GankContract.IGankView, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
	...
	protected void initView() {
		...
		gankPresenter.requestGankResource("App", PAGE_SIZE, 1);
	}
	...
	public void onRefresh() {
		...
		gankPresenter.requestRefreshResource("App", PAGE_SIZE, 1);
	}
	...
	public void onLoadMoreRequested() {
		...
		if (adapter.getData().size() < PAGE_SIZE) {
			...
			page++;
			gankPresenter.requestLoadMore("App", PAGE_SIZE, page);
		}
	}
}
